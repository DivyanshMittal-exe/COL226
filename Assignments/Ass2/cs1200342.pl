...
% Essentially for tail recursion, we need to have a list of Binary Trees to have tail recursion. It is similar to iterative graph search algorithms.
trPreorder(BT,L):-
