...
{fin = [(N 65)], trans = 9},
{fin = [(N 26),(N 67)], trans = 11},
{fin = [(N 32)], trans = 0},
{fin = [(N 19),(N 67)], trans = 0},
{fin = [(N 24),(N 67)], trans = 14},
{fin = [(N 22)], trans = 0},
{fin = [(N 29)], trans = 0},
{fin = [(N 50),(N 67)], trans = 0},
{fin = [(N 43),(N 67)], trans = 18},
{fin = [(N 41)], trans = 0},
{fin = [(N 46)], trans = 0},
{fin = [(N 7),(N 67)], trans = 21},
{fin = [(N 7)], trans = 21},
...
| 67 => let val yytext=yymktext() in throw(yytext, !linec); pos := !pos + size yytext;  lex() end
